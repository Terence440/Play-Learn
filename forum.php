...
<html lang="en">
  <head>
    ...
    <script
      src="https://kit.fontawesome.com/47b68a28dc.js"
  ...
  <body>
    <div id="wrapper_Header">
      <nav>
        ...
        <a class="cta" href="loginPage.php"
          ><button id="btn_SignIn">Sign In</button></a
        >
      </nav>
    </div>
    ...
    <section class="forum">
      ...
      <div class="box_forum" method="post">
        <h3>
          <a href="forumDetails.php"
            ><?php echo $forum_data['forum_title']; ?></a
          >
        </h3>
        <p>
          <?php echo $forum_data['forum_message']; ?>
        </p>
        <br />
        <a
          href="forumDetails.php"
          button
          type="submit"
          class="submit-btn"
          name="forum_id"
      ...
      <div class="box_forum">
        <h3>
          <a href="#"><?php echo $forum_data['forum_title']; ?></a>
        </h3>
        <p><?php echo $forum_data['forum_message']; ?></p>
        <br />
        <a href="forumDetails.php" class="button_forum1"> Read More </a>
      </div>
    </section>
    ...
    window.addEventListener("scroll", function () {
      ...
      if (window.scrollY == 0) {
        document.getElementById("logo").src =
          "assets\\resources\\logo_white.png";
      } else {
        document.getElementById("logo").src =
          "assets\\resources\\logo_black.png";
      }
    });
  </script>
</html>
